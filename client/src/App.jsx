    ...
    <AuthProvider>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/manufacturer/dashboard" element={<ProtectedRoute role="manufacturer"><ManufacturerDashboard /></ProtectedRoute>} />
          <Route path="/consumer/dashboard" element={<ProtectedRoute role="consumer"><ConsumerDashboard /></ProtectedRoute>} />
          <Route path="/logistics/dashboard" element={<ProtectedRoute role="logistics_agent"><LogisticsDashboard /></ProtectedRoute>} />
        </Routes>
      </BrowserRouter>
    </AuthProvider>
  );
